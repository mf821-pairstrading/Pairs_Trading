...
for n in range(7):
    ...
    r = HPDE(1,sigma[n],kappa,theta,theta-10*sigma[n],theta+10*sigma[n],3900,1200,c(n+1))
    H = r[0]
    band1 = r[1]
    r2 = GPDE(1,sigma[n],kappa,theta,theta-10*sigma[n],theta+10*sigma[n],3900,1200,c(n+1),H)
    G = r2[0]
    band2 = r2[1]
    ...
    exitband = []
    enterband = []
    for i in [x*10 for x in range(390)]:
